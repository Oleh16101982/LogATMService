...
namespace Logging
{
	public class fWriteFileLog
	{
		...
		public fWriteFileLog(String FileName, String DirName, int Number)
		{
			...
			catch (LogATMClient.cliServiceExceptions.EErrorCreateLogFileException e)
			{
				throw new LogATMClient.cliServiceExceptions.EErrorCreateLogFileException(e.ErrorLogFileMessage, 0x00);
			}
			catch (Exception e)
			{
		...
		protected void fDefFileName(String FileName = "", String DirName = "", int Number = 0)
		{
			...
			if (!Directory.Exists(fDirName))
			{
				...
				{
					throw new LogATMClient.cliServiceExceptions.EErrorCreateLogFileException("NotSupportedException.\n" + e.Message + "\n" + e.Source, 0x01);
				}
				catch (PathTooLongException e)
				{
					throw new LogATMClient.cliServiceExceptions.EErrorCreateLogFileException("PathTooLongException.\n" + e.Message + "\n" + e.Source, 0x02);
				}
				catch (DirectoryNotFoundException e)
				{
					throw new LogATMClient.cliServiceExceptions.EErrorCreateLogFileException("DirectoryNotFoundException.\n" + e.Message + "\n" + e.Source, 0x03);
				}
				catch (IOException e)
				{
					throw new LogATMClient.cliServiceExceptions.EErrorCreateLogFileException("IOException.\n" + e.Message + "\n" + e.Source, 0x04);
				}
				catch (UnauthorizedAccessException e)
				{
					throw new LogATMClient.cliServiceExceptions.EErrorCreateLogFileException("UnauthorizedAccessException.\n" + e.Message + "\n" + e.Source, 0x05);
				}
				catch (ArgumentNullException e)
				{
					throw new LogATMClient.cliServiceExceptions.EErrorCreateLogFileException("ArgumentNullException.\n" + e.Message + "\n" + e.Source, 0x06);
				}
				catch (ArgumentException e)
				{
					throw new LogATMClient.cliServiceExceptions.EErrorCreateLogFileException("ArgumentException.\n" + e.Message + "\n" + e.Source, 0x07);
				}
				catch (Exception e)
				{
					throw new LogATMClient.cliServiceExceptions.EErrorCreateLogFileException("Exception.\n" + e.Message + "\n" + e.Source, 0x08);
				}
			}
		}
		...
		public void WriteLog(String TextMsg)
		{
			...
			{
				throw new LogATMClient.cliServiceExceptions.EWriteToLogFileException(e.Message +"\n" + e.Source, 0x01);
			}
